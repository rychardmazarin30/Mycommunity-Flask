...
from my_community.forms import FormCriarConta, FormEditPassword, FormLogin, FormEditProfile, FormEditPassword, FormExcludeAccount, FormCreatePost, ExcludePost
from my_community.models import Usuario, Post
from flask_login import login_user, login_required, current_user, logout_user
from my_community import app, db
